...
const colors = [
  ...
  ["dark seagreen", "#8fbc8f", "darkseagreen"],
  ["dark slateblue", "#483d8b", "darkslateblue"],
  ["dark slategray", "#2f4f4f", "darkslategray"],
  ["dark slategrey", "#2f4f4f", "darkslategrey"],
  ["dark turquoise", "#00ced1", "darkturquoise"],
  ["dark violet", "#9400d3", "darkviolet"],
  ["deep pink", "#ff1493", "deeppink"],
  ["deep skyblue", "#00bfff", "deepskyblue"],
